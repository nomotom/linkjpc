...
_--wl_break_|flag to stop searching candidate wikilinks at the line in which nearest candidate link is found.| | |1<br>(cf.OptInfo.wl_break_default)|
